...
<head>
    ...
    <title>Metele pata - Pata de ternera</title>
</head>
<body>
    <header>
    ...
    <section id="compra-cerdo">
        <div class="contenedor">
            <div class="contenedor-descr">
                <h2>Pata de ternera</h2>
                <p>Proba la mas rica pata de ternera de Argentina! <br>
                ...
                <h2 class="precio">A solo $10500</h2>
            </div>
            <i class="fa-solid fa-cart-shopping" id="icon_shop"> <a href="https://wa.me/5493517601590?text=Quiero encargar una pata de ternera"
